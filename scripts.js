...
//By iterating on the pinArray, the aim is to auto populate DOM elements
/* pinArray.forEach(coin => (createDom(idFetchMatch(coin)))) */
pinArray.forEach(coin => fetchCoins(coin).then((res => createDom(res,savedResults))))